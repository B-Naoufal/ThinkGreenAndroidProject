...
public class PictureAdapter extends RecyclerView.Adapter<PictureAdapter.PictureViewHolder> {
    ...
    public ArrayList<Picture> picturesend;
    ...
    public void onBindViewHolder(final PictureViewHolder holder, int position) {
        ...
        while(holder.favorisBtn.isChecked())
        {
            holder.usernameCard.getText();
            holder.timeCard.getText();
            picturesend.add(0,picture);
            Intent lintent = new Intent(activity , Youtubeplayer.class);
            lintent.putExtra("stock_list", picturesend);
        ...
        holder.favorisBtn.setOnClickListener(new View.OnClickListener() {
    ...
    public class PictureViewHolder extends RecyclerView.ViewHolder
    {
        ...
        private CheckBox favorisBtn;

        public PictureViewHolder(View itemView) {
            super(itemView);
            pictureCard     = (ImageView) itemView.findViewById(R.id.pictureofCard);
            usernameCard    = (TextView)  itemView.findViewById(R.id.userNameCard);
            timeCard        = (TextView)  itemView.findViewById(R.id.timeCard);
            favorisBtn      = (CheckBox)  itemView.findViewById(R.id.likeCheckCard);
